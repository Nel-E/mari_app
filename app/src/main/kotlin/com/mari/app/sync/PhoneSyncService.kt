...
class PhoneSyncService : WearableListenerService() {
    ...
    @Inject lateinit var client: PhoneSyncClient
    @Inject lateinit var conflictQueue: ConflictQueue
    ...
    override fun onDataChanged(dataEvents: DataEventBuffer) {
        dataEvents.forEach { event ->
            ...
            serviceScope.launch {
                ...
                Wearable.getDataClient(this@PhoneSyncService).deleteDataItems(item.uri)
            }
        }
    }
